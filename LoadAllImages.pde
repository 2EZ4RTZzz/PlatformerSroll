...
PImage[] switchImgs = new PImage[3];
PImage[] catImgs = new PImage[4];
PImage[] groundImgs = new PImage[3];
PImage[] ground2Imgs = new PImage[3];
PImage groundBaseImg;
...
void loadAllImages() {
  ...
  for (int i = 0; i < switchImgs.length; i++) {
    switchImgs[i] = loadImage("switch" + i + ".png");
    switchImgs[i].resize(50, 50);
  }
  ...
  for (int i = 0; i < ground2Imgs.length; i++) {
    ground2Imgs[i] = loadImage("ground2-" + i + ".png");
    ground2Imgs[i].resize(40, 40);
  }
  ...
  groundBaseImg = loadImage("groundBase.png");
  groundBaseImg.resize(40, 40);
